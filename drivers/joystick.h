...
#define JOYSTICK_THRESH_X_LEFT_2P475V   0x8A3D
#define JOYSTICK_THRESH_X_RIGHT_0P825V  0x1EB8
#define JOYSTICK_THRESH_Y_UP_2P475V     0x8A3D
#define JOYSTICK_THRESH_Y_DOWN_0P825V   0x1EB8
/* Public API */
