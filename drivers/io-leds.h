...
/* Push Button (SW) Pins */
#define PIN_RGB_RED                 P0_0        // MODIFY
#define PIN_RGB_GRN                 P0_0        // MODIFY
#define PIN_RGB_BLU                 P0_0        // MODIFY

/* Bit Masks for Push Buttons */
#define MASK_RGB_RED                (1 << 0)    // MODIFY
#define MASK_RGB_GRN                (1 << 0)    // MODIFY
#define MASK_RGB_BLU                (1 << 0)    // MODIFY

/* Define a Macro for accessing the Port used to control
*  each of the LEDs
*/
#define PORT_RGB_RED                GPIO_PRT0   // MODIFY 
#define PORT_RGB_GRN                GPIO_PRT0   // MODIFY 
#define PORT_RGB_BLU                GPIO_PRT0   // MODIFY
